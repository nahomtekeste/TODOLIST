...
class DBHandler(val context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    // this code here createing the database ourselfes
    ...
    //we are here inserting the database
    ...
    // this function allow us to get our data content from the database
    ...
    // this code here allow us to add value to our SQL data base
    ...
    // this funtion here to be able to update the subtask data
    ...
    // this funtion get the iteam that is been written there
